...
//#############################################################################-
  ...
  void retrieveFormData() async {
    ...
    if (phonedata.isNotEmpty) {
      ...
      _phoneNum2.value = TextEditingValue(text: phonedata[1]);
      _phoneNum3.value = TextEditingValue(text: phonedata[2]);
    }
  }
  ...
  Future<void> _sendSMS(String message, List<String> recipents) async {
    // String result = await sendSMS(message: message, recipients: recipents,sendDirect: true ).catchError((onError) {
  ...
  showAlertDialog(BuildContext context, String sms) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () {
        _sendSMS(sms, [_phoneNum1.text, _phoneNum2.text, _phoneNum3.text]);
        Navigator.of(context).pop();
        saveFormtoPrefs();
      },
    );
    ...
    return Padding(
        ...
        child: Container(
            ...
            child: Column(
              ...
              children: [
                const Text('Enter Phone numbers to send SMS.',
                    style: TextStyle(
